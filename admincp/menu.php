          ...
          <td valign="top" class="style_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td onMouseOver="bgColor='#c9daf6'" onMouseOut="bgColor='#FFFFFF'" onMouseDown="ondown(this,'./media/list_song.php?mode=songs')" style="padding-left:7px; cursor:pointer;" height="19">Danh sách media </td>
              ...
              <tr>
                ...
                <td onMouseOver="bgColor='#c9daf6'" onMouseOut="bgColor='#FFFFFF'" onMouseDown="ondown(this,'./media/list_song.php?mode=clip_music')" style="padding-left:7px; cursor:pointer;" height="19">Danh sách video</td>
              ...
              <tr>
                ...
                <td onMouseOver="bgColor='#c9daf6'" onMouseOut="bgColor='#FFFFFF'" onMouseDown="ondown(this,'./media/list_song.php?mode=broken')" style="padding-left:7px; cursor:pointer;" height="19">Danh sách media bị lỗi</td>
              ...
              <tr>
                ...
                <td onMouseOver="bgColor='#c9daf6'" onMouseOut="bgColor='#FFFFFF'" onMouseDown="ondown(this,'./media/list_song.php?mode=top_hot')" style="padding-left:7px; cursor:pointer;" height="19">Danh sách top hot</td>
              ...
              <tr>
                ...
                <td onMouseOver="bgColor='#c9daf6'" onMouseOut="bgColor='#FFFFFF'" onMouseDown="ondown(this,'./media/list_song.php?mode=hq')" style="padding-left:7px; cursor:pointer;" height="19">D/s nhạc 320kps</td>
              ...
              <tr>
                ...
                <td onMouseOver="bgColor='#c9daf6'" onMouseOut="bgColor='#FFFFFF'" onMouseDown="ondown(this,'./media/list_song.php?mode=mem_upload')" style="padding-left:7px; cursor:pointer;" height="19">D/s media mem upload</td>
              </tr>
              <tr>
                <td height="1" bgcolor="#CCCCCC"></td>
              </tr>
